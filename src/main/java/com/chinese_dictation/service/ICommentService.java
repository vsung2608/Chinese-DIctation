...
public interface ICommentService {
    CommentResponse createComment(MultipartFile attachImage, NewCommentRequest request, Long userId);
    ...
    DataPagedResponse<CommentResponse> getCommentOrderByDate(int page, int size);
